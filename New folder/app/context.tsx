...
export const UIProvider: FC = (props) => {
  ...
  const openLeftSidebar = () => dispatch({ type: 'OPEN_LEFT_SIDEBAR' })
  const closeLeftSidebar = () => dispatch({ type: 'CLOSE_LEFT_SIDEBAR' })
  ...
  const closeSidebarIfPresent = () =>
    ...
    state.displayLeftSidebar
      ? dispatch({ type: 'CLOSE_LEFT_SIDEBAR' })
      : dispatch({ type: 'OPEN_LEFT_SIDEBAR' })
  const closeLeftSidebarIfPresent = () =>
    state.displayLeftSidebar && dispatch({ type: 'CLOSE_LEFT_SIDEBAR' })
